...
const TermsOfService = () => {
  return (
    <div id="terms" className="container-fluid mt-3">
      <div className="h3 mt-3">Terms of Service</div>
      <div className="mtb-1">
      Last updated: April 26, 2021
      </div>
      <h5 className="mt-3" >Acceptance of Terms of Service</h5>
      ...
      <h5 className="mt-3">Authorized Users</h5>
      ...
      <h5 className="mt-3">User Submissions</h5>
      ...
      <h5 className="mt-3">Consultants</h5>
      ...
      <h5 className="mt-3">Copyright Infringement</h5>
      ...
      <h5 className="mt-3">Disclaimer of Liability</h5>
      ...
      <h5 className="mt-3">Applicable Law</h5>
      By using Talktree.me, you agree to any applicable federal and state laws.
      <h5 className="mt-3">Termination of Use</h5>
